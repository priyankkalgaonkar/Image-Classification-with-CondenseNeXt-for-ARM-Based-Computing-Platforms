#CIFAR-100 Image Classification Script of NXP BlueBox 2.0 using RTMaps.
import rtmaps.types
import numpy as np
...
# Core() is called every time you have a new input
    def Core(self):
        ...
        args = parser.parse_args(["--model", "condensenet", "-b", "64", "-j", "12", "cifar100", "--stages", "4-4-4", "--growth", "8-8-8", "--gpu", "0"])
